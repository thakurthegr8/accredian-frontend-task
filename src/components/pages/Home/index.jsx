    ...
    return (
        <Container maxWidth="md">
            <Stack mt={8} justifyContent="center" alignItems="center" gap={4}>
                <Typography variant="h4" align='center' sx={{ fontWeight: "bold" }}>Accredian auth demonstration</Typography>
                ...
                <img src="https://illustrations.popsy.co/blue/late-for-meeting.svg" style={{ maxWidth: 320, mixBlendMode: "darken" }} />
            </Stack >
        </Container >
    )
}
